...
const DEFAULT_PASSWORD = "HIPREL#REQ26";
      ...
      {section === "create" && (
        <>
          ...
          {createMode === "single" ? (
            ...
            >
              <h3 className="font-semibold text-gray-800">Create Reviewer Account</h3>
              <div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  ...
                  is assigned and the reviewer must reset on first sign-in.
                </p>
              </div>
              <button
                type="submit"
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
              ...
              <textarea
                ...
                placeholder={"reviewer1@example.com\nreviewer2@example.com,Password456"}
                rows={8}
